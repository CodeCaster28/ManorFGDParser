---
title: monster_houndeye
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Doggy creature which use sonic waves on his enemies. Gain more strength when in group.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
