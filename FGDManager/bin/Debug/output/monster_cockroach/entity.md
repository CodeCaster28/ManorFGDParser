---
title: monster_cockroach
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Do not afraid, it's just a roach! Smashed when someone steps by on it.<br>Class: Insect.</div>
</div>
</div>
###Keyvalues
<hr>
