---
title: monster_zombie_barney
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Barney possessed by headcrab. Slow but dangerous in close combat. Stronger than regular zombie.<br>Alien Monster.</div>
</div>
</div>
<div>
