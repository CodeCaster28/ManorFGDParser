---
title: monster_gonome
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Mutated headcrab Zombie, faster, stronger and does much more damage with his claws. Also shoots organic projectiles from his chest.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
