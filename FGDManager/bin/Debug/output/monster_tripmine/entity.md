---
title: monster_tripmine
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Creates planted Tripmine that explodes when it's detection beam is touched.</div>
</div>
</div>
###Keyvalues
<hr>
...
<ul>
<li class="imagepadding" markdown="1"><b>1 </b> : <span style="color:#9fc5e8;">Instant On</span> : Spawn with detection beam turned on.</li>
