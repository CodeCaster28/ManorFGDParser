---
title: monster_pitdrone
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Fast monster that is deadly in melee combat. Shoots spikes from distance.<br>Class: Race X Pit Drone.</div>
</div>
</div>
###Keyvalues
<hr>
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Initial Ammo</b></span> <kbd  class="tooltip" data-tooltip="string">initammo</kbd> :
