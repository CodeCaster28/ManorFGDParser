---
title: monster_blkop_apache
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Apache that uses chain gun, as well as destructive missiles. Explodes after destroyed so stay clear.<br>Class: Human Military.</div>
</div>
</div>
###Keyvalues
<hr>
...
<li class="imagepadding" markdown="1"><b>8 </b> : <span style="color:#9fc5e8;">NoWreckage</span> : Do not produce gibs after destroyed.</li>
...
<li class="imagepadding" markdown="1"><b>64 </b> : <span style="color:#9fc5e8;">Start Inactive</span> : Start disabled, ignore environment until triggered.</li>
