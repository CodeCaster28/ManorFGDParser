---
title: monster_human_assassin
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Not easy to defeat with ninja-like abilities. Nimble killer, deadly, can jump on incredible heights.<br>Class: Human Military.</div>
</div>
</div>
<div>
