---
title: monster_nihilanth
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Xen most powerful creature. Wield power that is beyond human imagination.<br>Class: Alien Military.</div>
</div>
</div>
###Keyvalues
<hr>
