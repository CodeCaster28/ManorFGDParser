---
title: monster_bullchicken
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Bullsquid. Aggressive predator that split acid at his foes and using powerful tail attacks.<br>Class: Alien Predator.</div>
</div>
</div>
###Keyvalues
<hr>
