---
title: monster_robogrunt
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Robot that is partially immune to bullets, wide weaponry usage. Explodes after destroyed.<br>Class: Machine.</div>
</div>
</div>
###Keyvalues
<hr>
