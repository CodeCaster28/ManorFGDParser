...
<div class="column entityentry" markdown="1">Gives the player 25 armor points, by default. The additional armor will be drained by one point every two seconds if it's over the limit.</div>
</div>
</div>
###Keyvalues
<hr>
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Charge Supplied</b></span> <kbd  class="tooltip" data-tooltip="integer">health</kbd> :
Custom armor points to give player instead of default ones.
</div>
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Charge Cap</b></span> <kbd  class="tooltip" data-tooltip="integer">healthcap</kbd> :
