...
Entity to trigger when player touched it or air tank has been recharged (after 30 seconds cooldown). Trigger use-type is 'Toggle'.
</div>
<div class="entityentry" markdown="1">
...
Entity to remove when air tank is touched by player.
</div>
...
<div class="notices blue" markdown="1">As opposed to other items entities, this cannot be triggered to collect/use.</div>
