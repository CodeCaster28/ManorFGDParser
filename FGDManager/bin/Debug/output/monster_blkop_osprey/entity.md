---
title: monster_blkop_osprey
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Black osprey delivers human assassins. Shoot it's rotor to destroy it. Also care for explosion he made after destroyed.<br>Class: Machine.</div>
</div>
</div>
###Keyvalues
<hr>
