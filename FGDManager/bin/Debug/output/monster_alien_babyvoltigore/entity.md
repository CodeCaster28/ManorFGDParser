---
title: monster_alien_babyvoltigore
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Baby version of [Voltigore](../monster_alien_voltigore). Cannot shoot beams like it's mother.<br>Class: Race X Shock.</div>
</div>
</div>
###Keyvalues
<hr>
