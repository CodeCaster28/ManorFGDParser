---
title: monster_bigmomma
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Big four-legged monstrous creature Gonarch. Spawn [baby headcrabs](../monster_babycrab), split spores and uses his legs in closer combat.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>First node</b></span> <kbd  class="tooltip" data-tooltip="string">netname</kbd> :
Name of the first [info_bigmomma](../info_bigmomma) entity to control scripted sequence of this gonarch.
</div>
###Flags
<hr>
...
<li class="imagepadding" markdown="1"><b>1024</b> : <span style="color:#9fc5e8;">No Babycrabs</span> : Do not split babycrabs.</li>
