---
title: monster_hwgrunt
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Extremely durable grunt that wield Minigun. Large amount of damage and deadly accuracy.<br>Class: Human Military.</div>
</div>
</div>
###Keyvalues
<hr>
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Secondary Weapon</b></span> <kbd  class="tooltip" data-tooltip="Choices">weapons</kbd> :
You can choose which weapon the monster uses.
<div class="accordion">
...
<div class="accordion-body">
<ul>
<li><b>0 </b> : Random Pistol</li>
<li><b>1 </b> : Glock</li>
<li><b>2 </b> : Desert Eagle</li>
<li><b>3 </b> : 357 Python</li>
</ul>
</div>
</div>
</div>
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Disable Minigun Drop</b></span> <kbd  class="tooltip" data-tooltip="Choices">disable_minigun_drop</kbd> :
...
<li class="imagepadding" markdown="1"><b>32 </b> : SquadLeader : Select this flag if you want this monster to become a leader of squad typed in "Squad name".</li>
