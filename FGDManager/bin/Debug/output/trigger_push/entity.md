...
<div class="column entityentry" markdown="1">A simple brush entity for affecting entities inside it with acceleration towards a certain direction.</div>
</div>
</div>
###Keyvalues
<hr>
...
<ul>
<li class="imagepadding" markdown="1"><b>1</b> : <span style="color:#9fc5e8;">Once Only</span> : If set, this trigger_push will be active only for as long as the first affected entity entering it remains within it.</li>
<li class="imagepadding" markdown="1"><b>2</b> : <span style="color:#9fc5e8;">Start Off</span> : If set, this trigger_push will start disabled and requires activation per trigger.</li>
...
<li class="imagepadding" markdown="1"><b>8</b> : <span style="color:#9fc5e8;">No Clients</span> : If set, players won't be affected.</li>
<li class="imagepadding" markdown="1"><b>16</b> : <span style="color:#9fc5e8;">No Monsters</span> : If set, monsters won't be affected.</li>
...
<li class="imagepadding" markdown="1"><b>64</b> : <span style="color:#9fc5e8;">Force push</span> : Prevents players and monsters from moving in the opposite direction of the push.</li>
