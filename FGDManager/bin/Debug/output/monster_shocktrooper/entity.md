---
title: monster_shocktrooper
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Hard to defeat alien that shoots fast projectiles using Shockroach. Also quipped with acid grenade that poisons when explodes for a moderate amount of time. Drop [Shockroach](../monster_shockroach) after death.<br>Class: Race X Shock.</div>
</div>
</div>
###Keyvalues
<hr>
...
<li class="imagepadding" markdown="1"><b>1024</b> : No Shockroach : Do not drop shockroach upon death.</li>
