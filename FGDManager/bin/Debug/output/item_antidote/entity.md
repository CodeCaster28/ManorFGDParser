...
<div class="column entityentry" markdown="1">This item is an antidote against poison damage. Unimplemented in Half-Life but is functional in Sven Co-op. The usefulness of this item is questionable, as there are no strong, long-lasting poison damage-effects in game.</div>
</div>
</div>
###Keyvalues
<hr>
