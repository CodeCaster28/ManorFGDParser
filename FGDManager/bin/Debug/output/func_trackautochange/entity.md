...
Travel distance, from top to bottom. If "Start at Bottom" flag is selected, the travel distance won't change from bottom to top, it only makes platform start at bottom and awaits for func_tracktrain to arrive.
</div>
<div class="entityentry" markdown="1">
...
Name of the func_tracktrain this platform will transport to top/bottom track.
</div>
<div class="entityentry" markdown="1">
