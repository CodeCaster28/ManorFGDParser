---
title: monster_alien_slave
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Enslaved Vortigaunts that serves military aliens in their battle. Uses lighting bolts to hurt opponents and to revive other fallen vortigaunts.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
...
<li class="imagepadding" markdown="1"><b>64 </b> : IgnorePlayer : Ignore players presence.</li>
