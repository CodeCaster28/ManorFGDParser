---
title: monster_zombie_soldier
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Human Grunt possessed by headcrab. Slow but dangerous in close combat. Stronger than both regular and barney zombie.<br>Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
