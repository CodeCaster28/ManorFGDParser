...
<div class="column entityentry" markdown="1">Baby version od [Gargantua](../monster_gargantua) that is much smaller and not invulnerable to bullets.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
