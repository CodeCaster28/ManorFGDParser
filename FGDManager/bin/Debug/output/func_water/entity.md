...
<li class="imagepadding" markdown="1"><b>256</b> : USE Only : If set, this water can be triggered by using it but not by touching it anymore. It should be selected if you need your water to be opened or closed by using it by whatever reason.</li>
