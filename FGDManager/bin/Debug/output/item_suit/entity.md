...
<div class="column entityentry" markdown="1">The Hazardous Environment (H.E.V.) Protection Suit, which allows the player to use [item_battery](../item_battery), as well as giving him a crosshair to aim and a fully functional Head-up display (HUD) featuring health, armor, ammunition, damage and flashlight power indicators. Private flag:</div>
</div>
</div>
###Keyvalues
<hr>
...
<ul>
<li class="imagepadding" markdown="1"><b>1 </b> : <span style="color:#9fc5e8;">Short Logon</span> : Shorter H.E.V. Suit (item_suit) audio assistant.</li>
