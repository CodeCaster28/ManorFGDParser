...
<div class="column">Provides 17 bullets for weapon_9mmhandgun (Glock), weapon_9mmAR (MP5), weapon_uzi (Uzi) and weapon_uziakimbo (Uzi akimbo). Maximum in supply: 250</div>
</div>
</div>
###Keyvalues
<hr>
