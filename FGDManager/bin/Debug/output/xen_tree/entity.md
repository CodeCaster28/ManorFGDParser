...
<div class="column entityentry" markdown="1">An aggressive life form that hits his enemy whenever they stand under it. It also react when it's attacked.</div>
</div>
</div>
###Keyvalues
<hr>
...
<li class="imagepadding" markdown="1"><b>8 </b> : <span style="color:#9fc5e8;">Non Solid</span> : Disables collision box of entity. It still can hurt you.</li>
