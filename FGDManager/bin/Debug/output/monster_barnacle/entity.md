---
title: monster_barnacle
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Stationary monster that hangs down from ceiling and use his tongue to pull up preys into it's month.<br>Class: Alien Predator.</div>
</div>
</div>
###Keyvalues
<hr>
