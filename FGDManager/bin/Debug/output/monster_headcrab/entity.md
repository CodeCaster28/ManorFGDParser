---
title: monster_headcrab
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Alien monster that seek for potential prey to be attacked in most unexpected moment.<br>Class: Alien Prey.</div>
</div>
</div>
###Keyvalues
<hr>
