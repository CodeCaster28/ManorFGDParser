...
<div class="column entityentry" markdown="1">The Long Jump Module allows the player to jump over large distances and gaps and travel at a much faster pace, as well as climb upon slightly higher objects as without it. To use it, walk forwards, begin to crouch (keep running forward) and jump before going fully crouched.</div>
</div>
</div>
###Keyvalues
<hr>
