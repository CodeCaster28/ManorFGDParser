...
<div class="notices blue" markdown="1">If the func_door kills something which blocked it, it will proceed instead of returning (behavior was changed to this in SC 4.5).</div>
