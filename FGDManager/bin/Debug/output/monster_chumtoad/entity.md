---
title: monster_chumtoad
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Cute but dangerous toad that produces poisonous cloud when in danger.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
