---
title: monster_kingpin
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">One of the most powerful enemies. Shoots deadly homing energy orbs that explodes with sonic waves after hit an enemy or obstacle. Uses energy beams that are almost impossible to dodge. Teleports and reflects various projectiles. Also using shield that need to be destroyed before damaging Kingpin. Explodes after death.<br>Class: Alien Military.</div>
</div>
</div>
###Keyvalues
<hr>
