...
<ul>
<li class="imagepadding" markdown="1"><b>1 </b> : Initially dark : Shadows starts turned ON at start (should be reverted to light_shadow at start). Make sure this is selected when the brush is visible at start.</li>
