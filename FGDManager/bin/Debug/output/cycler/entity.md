...
<div class="column entityentry" markdown="1">The cycler entity is used to display models in your map. Its collision hull is solid to bullets and will spill black and white blood. The cycler entity will cycle through the model's animations every time it takes damage, of in case it gets triggered- cycle part of current animation. A better, non-solid alternative to this entity is [item_generic](../item_generic], which allows you to set up your own collisions using clip- or null-textured brushes.</div>
</div>
</div>
###Keyvalues
<hr>
...
Set name of {{ entname }} so other entities can trigger it to pause/unpause model. Every trigger use-type works uniformly. Paused model can't be hit to cycle through animations, some current animation frames are skipped instead.
</div>
<div class="entityentry" markdown="1">
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Model</b></span> <kbd  class="tooltip" data-tooltip="studio">model</kbd> :
Specify a valid model-file to display here. Path starts from within modification's folder e.g. 'models/cleansuit_scientist.mdl'
</div>
<div class="entityentry" markdown="1">
