---
title: monster_babycrab
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Baby version of [Headcrab](../monster_headcrab). Frequently spawned by [Gonarch](../monster_bigmomma).<br>Class: Alien Prey.</div>
</div>
</div>
<div>
