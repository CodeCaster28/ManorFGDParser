---
title: monster_gargantua
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Invulnerable to bullets large creature that uses flame attacks and flame stomps. He may eat enemies when they stays too close to him.<br>Class: Alien Monster.</div>
</div>
</div>
###Keyvalues
<hr>
