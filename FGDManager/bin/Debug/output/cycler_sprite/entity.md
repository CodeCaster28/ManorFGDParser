...
<div class="column entityentry" markdown="1">The {{ entname }} entity is used to display sprites in your map. When hit it will skip to next animation frame (if animated). It's solid so it will block bullets and entities like player. It is often erroneously being used to display models. For a better supported entity to display sprites, use [env_sprite](../env_sprite).</div>
</div>
</div>
###Keyvalues
<hr>
...
Set name of {{ entname }} so other entities can trigger it to pause sprite animations. Every trigger use-type works uniformly.
</div>
<div class="accordion entityentry">
...
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Sprite</b></span> <kbd  class="tooltip" data-tooltip="sprite">model</kbd> :
Specify a valid sprite-file to display here. Path starts from within modification's folder e.g. 'sprites/moths.spr'
</div>
<div class="entityentry" markdown="1">
<span style="color:#9fc5e8;"><b>Frames per second</b></span> <kbd  class="tooltip" data-tooltip="integer">framerate</kbd> :
Sprite framerate.
</div>
<div class="entityentry" markdown="1">
