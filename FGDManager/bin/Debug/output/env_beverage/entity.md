...
Set name of {{ entname }} so other entities can trigger it to spawn beverage (if no other is spawned at the moment). Any trigger signal type accepted. Can be killtargeted, already spawned models are not removed.
</div>
<div class="entityentry" markdown="1">
