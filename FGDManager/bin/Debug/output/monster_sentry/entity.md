---
title: monster_sentry
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Stationary turret that explodes after destroyed.<br>Class: Machine.</div>
</div>
</div>
###Keyvalues
<hr>
...
<li class="imagepadding" markdown="1"><b>32 </b> : <span style="color:#9fc5e8;">Autostart</span> : If selected, turrets can auto-activate themselfes when enemy is in their LoS.</li>
