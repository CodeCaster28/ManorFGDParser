---
title: monster_furniture
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Monster_furniture works in the same way as a [monster_generic](../monster_generic) does, but it has some features cut.</div>
</div>
</div>
###Keyvalues
<hr>
