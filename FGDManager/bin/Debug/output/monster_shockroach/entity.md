---
title: monster_shockroach
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Pickable insect that dies after a set amount of time when no one pick him up and use as a weapon. It's dropped by [Shock Trooper](../monster_shocktrooper).<br>Class: Alien Prey.</div>
</div>
</div>
###Keyvalues
<hr>
