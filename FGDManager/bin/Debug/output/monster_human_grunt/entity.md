---
title: monster_human_grunt
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Grunts can wield different types of weapons and works in group to eliminate targets.<br>Class: Human Military.</div>
</div>
</div>
###Keyvalues
<hr>
