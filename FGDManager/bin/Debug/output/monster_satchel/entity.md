---
title: monster_satchel
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Pushable Satchel that explodes after triggered.</div>
</div>
</div>
###Keyvalues
<hr>
...
Set name of {{ entname }} so other entities can trigger it to detonate. Every trigger use-type works uniformly. Can be kill-targeted.
</div>
<div class="entityentry" markdown="1">
