---
title: monster_sqknest
---
<div>{% set entname = page.title|raw %}</div>
<div class="container previewimg">
<div class="columns">
<div class="imagepadding column col-auto" markdown="1">![](preview.png)</div>
<div class="column entityentry" markdown="1">Live small amount of time. Snark nests are thrown by Alien Grunts. Breaks after short amount of time releasing a pack of snarks. It's better to destroy it, so it will release smaller amount of snarks.<br>Class: Alien Bioweapon.</div>
</div>
</div>
<div>
